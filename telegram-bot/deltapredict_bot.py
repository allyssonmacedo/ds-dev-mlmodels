#Este Bot envia a foto da última atualização do Solinftec que foi coletada com o script 'time_bot'
...
@bot.message_handler(commands=["197", "colheitamilho", "colheita de milho"])
def prever_suporte_regressao_logistica(mensagem):
